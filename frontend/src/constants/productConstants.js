...
export const PRODUCT_SLIDE_REQUEST = "PRODUCT_SLIDE_REQUEST";
export const PRODUCT_SLIDE_SUCCESS = "PRODUCT_SLIDE_SUCCESS";
export const PRODUCT_SLIDE_FAIL = "PRODUCT_SLIDE_FAIL";
